    ...
    <footer className="bg-gray-900 text-gray-300 font-opensans">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-playfair font-bold text-white mb-4">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-playfair font-bold text-white mb-4">Contact Us</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 mt-0.5 text-amber-500" />
                <span>Near Narayana Vatika Marriage Lawn , Takrohi</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@thehalwai.com</span>
              </li>
            </ul>
            <div className="mt-4">
              <h4 className="font-semibold text-white mb-2 font-playfair">Business Hours</h4>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-xl font-playfair font-bold text-white mb-4">Newsletter</h3>
            <p className="mb-4">
              Subscribe to our newsletter for special offers, new menu items, and catering tips.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm">
          <p>© {new Date().getFullYear()} The Halwai. All rights reserved.</p>
